...
import { 
  ...
  UserPlus, SearchCode, Handshake, Lock, ArrowRight
} from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-white font-sans pb-24 lg:pb-0">
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 lg:h-20 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <button className="px-4 py-2 text-xs font-bold border rounded-lg text-[#1e3a5f]">Giriş Yap</button>
            <button className="px-4 py-2 text-xs font-bold bg-[#f58220] text-white rounded-lg shadow-lg shadow-orange-100">Üye Ol</button>
          </div>
        </div>
      </header>
          ...
          <div className="w-full max-w-xl bg-white rounded-3xl p-2 shadow-2xl">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <select className="w-full p-3 bg-gray-50 border border-gray-100 rounded-xl text-sm outline-none focus:ring-2 ring-orange-100"><option>Şehir Seçin</option></select>
              </div>
              <div className="space-y-1">
      ...
      {/* MOBILE BOTTOM NAVIGATION (Uygulama Tarzı Alt Menü) */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 h-20 flex justify-between items-center z-[100] lg:hidden shadow-[0_-10px_30px_rgba(0,0,0,0.05)]">
        <Link href="/" className="flex flex-col items-center gap-1 text-[#1e3a5f]">
          <Home size={22} />
          <span className="text-[10px] font-black uppercase">Ana Sayfa</span>
        </Link>
        <Link href="#" className="flex flex-col items-center gap-1 text-gray-400">
          <Truck size={22} />
          <span className="text-[10px] font-black uppercase">İlanlar</span>
        </Link>
        ...
        <Link href="#" className="flex flex-col items-center gap-1 text-gray-400">
          <Bell size={22} />
          <span className="text-[10px] font-black uppercase">Bildirim</span>
        </Link>
        <Link href="#" className="flex flex-col items-center gap-1 text-gray-400">
          <User size={22} />
